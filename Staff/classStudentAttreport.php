...
$classId = $_GET['Clas'];
$studentId = $_GET['name'];
$sql = "SELECT COUNT(DISTINCT DATE) AS totalclass FROM attendance WHERE studentclass=$classId AND student_id=$studentId";
...
WHERE studentclass=$classId AND student_id=$studentId";
