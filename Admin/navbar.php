            ...
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" href="./staffLeaves.php">Staff Leaves</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="./saveAdmission.php">New Admission</a></li>
                        <li><a class="dropdown-item" href="./Admission.php">View Admission</a></li>
                        <!-- <li><a class="dropdown-item" href="#">Something else here</a></li> -->
                    </ul>
                </li>
                <!-- <a href="./Admission.php" class="nav-item nav-link">Admission</a> -->
                <a href="./result.php" class="nav-item nav-link">Result</a>
                <a href="./AttendanceReport.php" class="nav-item nav-link">Attendance</a>
